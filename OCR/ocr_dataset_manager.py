...
from dataset.generic_dataset_manager import DatasetManager, GenericDataset
from dataset.utils import pad_images, pad_image_width_right, resize_max, pad_image_width_random, pad_sequences_1D, pad_image_height_random, pad_image_width_left, pad_image
from basic.utils import randint, rand, rand_uniform
from dataset.generic_dataset_manager import apply_preprocessing
...
from dataset.transforms import RandomRotation, apply_transform, Tightening
...
class OCRDatasetManager(DatasetManager):
    ...
    def __init__(self, params):
        ...
        if "synthetic_data" in self.params["config"] and self.params["config"]["synthetic_data"] and "config" in self.params["config"]["synthetic_data"]:
            ...
            for token_dict in [READ_MATCHING_TOKENS]:
